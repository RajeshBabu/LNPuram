...
var familytree = require('./routes/familytree');
var narayanabapanayya = require('./routes/narayanabapanayya');
var app = express();
...
app.use('/lnp/familytree',familytree);
app.use('/lnp/narayanabapanayya',narayanabapanayya);
